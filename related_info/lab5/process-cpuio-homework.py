    ...
    def next_proc(self, pid=-1):
        ...
        while True:
            ...
            if pid == self.curr_proc:
                if self.proc_info[pid][PROC_STATE] == STATE_DONE or self.proc_info[pid][PROC_STATE] == STATE_WAIT:
                    return
                else:
                    break
...
parser.add_option('-L', '--iolength', default=3, help='how long an IO takes', action='store', type='int',
                  dest='io_length')
